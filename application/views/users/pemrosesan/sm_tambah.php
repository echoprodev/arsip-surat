            ...
            <div class="panel-body">
              ...
              <fieldset class="content-group">
                ...
                <form class="form-horizontal" action="users/sm"  enctype="multipart/form-data" method="post">
                    ...
                    <div class="form-group">
                      <label class="control-label col-lg-3">No.Arsip Surat</label>
                      <div class="col-lg-5">
    												<input type="text" name="no_surat" id="no_asalx" class="form-control" placeholder="" value="<?php echo $no_surat; ?>" required readonly>
    									</div>
                      <div class="col-lg-4">
                        <div class="input-group">
                          <span class="input-group-addon"><i class="icon-calendar"></i></span>
                          <input type="text" name="tgl_ns" class="form-control daterange-single" id="tgl_no_asal" value="<?php echo date('d-m-Y'); ?>" maxlength="10" required placeholder="Masukkan Tanggal">
                        </div>
                      </div>
                    </div>
                    <div class="form-group">
                      ...
                      <div class="col-lg-4">
                        <div class="input-group">
                          <span class="input-group-addon"><i class="icon-calendar"></i></span>
                          <input type="date" name="tgl_no_asal" class="form-control daterange-single" id="tgl_no_asal" value="" maxlength="10" required placeholder="Masukkan Tanggal">
                        </div>
                      </div>
                    </div>
