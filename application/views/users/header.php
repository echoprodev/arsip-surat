...
<body>
	...
	<!-- Main navbar -->
	<div class="navbar navbar-default header-highlight bg-success">
		<div class="navbar-header bg-primary">
			<a class="navbar-brand" href="">
				<img src="assets/images/logo.png" alt="" style="width: 50px; height:50px; margin-top:-15px;">
				<h3 class="text-white" style="margin-left: 60px; margin-top: -40px;">Kejaksaan Negeri</h3>
			</a>
						...
						<div class="category-content no-padding">
							<ul class="navigation navigation-main navigation-accordion">
									...
									<li class="<?php if ($sub_menu == "pengguna") {
										...
										<ul>
											...
											if ($user->row()->level == 's_admin') { ?>
												<li class="<?php if ($sub_menu == "pengguna") {
																echo 'active';
															} ?>"><a href="users/pengguna"><i class="icon-users"></i> USER</a></li>
											<?php
											} ?>
											<!-- <li class="<?php if ($sub_menu == "bagian") {
															echo 'active';
														} ?>"><a href="users/bagian"><i class="icon-puzzle3"></i>BIDANG</a></li> -->
											<!-- <li class="<?php if ($sub_menu == "ns") {
																echo 'active';
															} ?>"><a href="users/ns"><i class="icon-cube"></i> Nomor Surat</a></li> -->
										</ul>
									</li>
								<?php
								} ?>
								...
								<li class="<?php if ($sub_menu == "lap_sk" or $sub_menu == "lap_sm") {
									...
									<a href="#"><i class="icon-printer4"></i> <span>LAPORAN ARSIP SURAT</span></a>
									<ul>
